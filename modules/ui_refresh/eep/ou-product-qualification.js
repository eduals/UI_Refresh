    ...
    var SiteName = pathArray[1];
      ...
      // Courses - level 1
    page_id = ((pathname.indexOf("/" + SiteName) != -1) ? 'ou-page-courses' : page_id);

    // Courses - level 2
    page_id = ((pathname.indexOf(SiteName + "/atoz") != -1) ? 'ou-page-courses-atoz' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/types") != -1) ? 'ou-page-courses-types' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/careers") != -1) ? 'ou-page-courses-careers' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/what-study-like") != -1) ? 'ou-page-courses-whatitslike' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/do-it") != -1) ? 'ou-page-courses-doit' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/fees-and-funding") != -1) ? 'ou-page-courses-fees' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/apply") != -1) ? 'ou-page-courses-apply' : page_id);

    // Courses - level 3 (Can i do it)
    page_id = ((pathname.indexOf(SiteName + "/do-it/finding-time") != -1) ? 'ou-page-courses-doit-time' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/do-it/english-skills") != -1) ? 'ou-page-courses-doit-english' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/do-it/access") != -1) ? 'ou-page-courses-doit-access' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/do-it/computing-skills") != -1) ? 'ou-page-courses-doit-computing' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/do-it/disability") != -1) ? 'ou-page-courses-doit-disability' : page_id);

    // Courses - level 3 (What its like to study)
    page_id = ((pathname.indexOf(SiteName + "/what-study-like/distance-learning") != -1) ? 'ou-page-courses-whatitslike-distance' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/what-study-like/tutor-support") != -1) ? 'ou-page-courses-whatitslike-tutor' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/what-study-like/learning-resources") != -1) ? 'ou-page-courses-whatitslike-resources' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/what-study-like/community") != -1) ? 'ou-page-courses-whatitslike-community' : page_id);

    // Courses - level 3 (Course types)
    page_id = ((pathname.indexOf(SiteName + "/degrees") != -1) ? 'ou-page-courses-types-honours' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/integrated-masters") != -1) ? 'ou-page-courses-types-integrated-masters' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/foundation-degrees") != -1) ? 'ou-page-courses-types-foundation' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/modules") != -1) ? 'ou-page-courses-types-modules' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/modules/") != -1) ? 'ou-page-courses' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/diplomas-he") != -1) ? 'ou-page-courses-types-diplomas-he' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/certificates-he") != -1) ? 'ou-page-courses-types-certificates-he' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/short-courses") != -1) ? 'ou-page-courses-types-short' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/short-courses/") != -1) ? 'ou-page-courses' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/diplomas-ou") != -1) ? 'ou-page-courses-types-diplomas-ou' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/all") != -1) ? 'ou-page-courses-types-courses' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/certificates-ou") != -1) ? 'ou-page-courses-certificates-ou' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/open-qualification") != -1) ? 'ou-page-courses-types-open-qualification' : page_id);

    // Courses - level 3 (Careers)
    page_id = ((pathname.indexOf(SiteName + "/careers/counselling") != -1) ? 'ou-page-courses-careers-counselling' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/careers/psychology") != -1) ? 'ou-page-courses-careers-psychology' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/careers/teaching") != -1) ? 'ou-page-courses-careers-teaching' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/careers/working-with-children") != -1) ? 'ou-page-courses-careers-children' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/careers/social-work") != -1) ? 'ou-page-courses-careers-social' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/careers/management") != -1) ? 'ou-page-courses-careers-management' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/careers/accountancy") != -1) ? 'ou-page-courses-careers-accountancy' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/careers/engineering") != -1) ? 'ou-page-courses-careers-engineering' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/careers/environment") != -1) ? 'ou-page-courses-careers-environment' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/careers/it-and-computing") != -1) ? 'ou-page-courses-careers-it-and-computing' : page_id);
    page_id = ((pathname.indexOf(SiteName + "/careers/law") != -1) ? 'ou-page-courses-careers-law' : page_id);
    ...
    if (typeof qualificationCode !== 'undefined') {
        ...
        if (qualificationCode.length > 2) {
            ...
            var s = 'category=qualification&ou_ev_ty=navigation&ou_ev_ac=page-load&ou_ev_mt=auto&ou_ev_pl=tab-menu' + refer + '&ou_ev_refas=none&ou_ev_val=none&ou_ev_msg=none&ou_qual=' + qualificationCode;
    ...
    $('a.product-qual-register').click(function (e) {
        ...
        // Build up the tracking string.
        var s = 'category=qualification&ou_ev_ty=navigation&ou_ev_ac=off-page&ou_ev_mt=button&ou_ev_pl=register-cta&ou_ev_as=register-now' + refer + '&ou_ev_val=none&ou_ev_msg=none&ou_qual=' + qualificationCode;
    ...
    $('a.product-qual-prospectus-request').click(function (e) {
        ...
        // Build up the tracking string.
        var s = 'category=qualification&ou_ev_ty=navigation&ou_ev_ac=off-page&ou_ev_mt=button&ou_ev_pl=prospectus-cta&ou_ev_as=request-prospectus' + refer + '&ou_ev_val=none&ou_ev_msg=none&ou_qual=' + qualificationCode + '&ou_mod=';
    ...
    $('a.qual-infographic').click(function (e) {
        ...
        // Build up the tracking string.
        var s = 'category=qualification&ou_ev_ty=info-display&ou_ev_ac=on-page&ou_ev_mt=button&ou_ev_pl=details&ou_ev_as=infographic&ou_ev_refas=none&ou_ev_val=none&ou_ev_msg=none&ou_qual=' + qualificationCode;
    ...
    $('a.qual-tab-click').click(function (e)
    {
        ...
        // Build up the tracking string.
        var s = 'category=qualification&ou_ev_ty=navigation&ou_ev_ac=on-page&ou_ev_mt=click&ou_ev_pl=tab-menu' + tab_to + tab_from + '&ou_ev_val=none&ou_ev_msg=none&ou_qual=' + qualificationCode;
    ...
    $('.product-qual-registration-tracker').on('change', function (e) {
        ...
        if (OnLoadOptionSelected != '-') {
            ...
            var s = 'category=qualification&ou_ev_ty=data-display&ou_ev_ac=on-page&ou_ev_mt=dropdown&ou_ev_pl=register-cta&ou_ev_as=registration-start' + refer + '&ou_ev_val=none&ou_ev_msg=none&ou_qual=' + qualificationCode;

            // Call the common tracker function.
            EEP_Dax_tracker(sPageName, TrackedObject, s);

        } else { OnLoadOptionSelected = valueSelected; }
    ...
    $('.widgetCompareButton').click(function (e) {
        ...
        // Build up the tracking string.
        var s = 'category=qualification&ou_ev_ty=navigation&ou_ev_ac=off-site&ou_ev_mt=link&ou_ev_pl=details&ou_ev_as=kis-widget&ou_ev_refas=none&ou_ev_val=none&ou_ev_msg=none&ou_qual=' + qualificationCode;
    ...
    $('.product-qual-access-modules').on('click', function (e) {
        ...
        // Build up the tracking string.
        var s = 'category=qualification&ou_ev_ty=navigation&ou_ev_ac=on-page&ou_ev_mt=click&ou_ev_pl=access&ou_ev_as=' + revealState + '&ou_ev_refas=none&ou_ev_val=none&ou_ev_msg=none&ou_qual=' + qualificationCode + '&ou_mod=' + moduleCode;
    ...
    $('a.product-module-prospectus-request').click(function (e) {
        ...
        // Build up the tracking string.
        var s = 'category=module&ou_ev_ty=navigation&ou_ev_ac=off-page&ou_ev_mt=button&ou_ev_pl=prospectus-cta&ou_ev_as=request-prospectus' + refer + '&ou_ev_val=none&ou_ev_msg=none&ou_mod=' + moduleCode;
    ...
    $('a.tab-click').click(function (e) {
        ...
        // Build up the tracking string.
        var s = 'category=module&ou_ev_ty=navigation&ou_ev_ac=on-page&ou_ev_mt=click&ou_ev_pl=tab-menu' + newTab + refer + '&ou_ev_val=none&ou_ev_msg=none&ou_mod=' + moduleCode;
    ...
    if ($('#divModuleCode').css("visibility") == "hidden") {
        ...
        if (moduleCode.length > 2) {
            ...
            // Build up the tracking string.
            var s = 'category=module&ou_ev_ty=navigation&ou_ev_ac=page-load&ou_ev_mt=auto&ou_ev_pl=tab-menu' + refer + '&ou_ev_refas=none&ou_ev_val=none&ou_ev_msg=none&ou_mod=' + moduleCode;
