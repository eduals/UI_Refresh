...
// ----------------------------------------------------------
// v2.13
// IE8 and lower fallback for displaying tabbing instructions
// ----------------------------------------------------------
...
(function ($, window, df, undefined) {
    ...
    df.PrimaryNavigation.version = 'OU.DigitalFramework.Global.PrimaryNavigation | v2.13';
            ...
            if (this.options.preventScroll) {
                ...
                if (df.ie <= 8) {
                    ...
                    $(document).keydown(function (e) {
                        ...
                        if ($.inArray(key, ar) > -1 && $(document.activeElement).closest(base.$nav).length !== 0) {
                            e.preventDefault();
                            return false;
                        }
                        return true;
                    ...
                    //IE8 and lower fallback for displaying tab messages
                    $('.int-menu-tab-info-anchor')
                        .focus(function () {
                            $(this).next('.int-menu-tab-info-container').show();
                        })
                        .blur(function () {
                            $(this).next('.int-menu-tab-info-container').hide();
                        });
                }
            }
