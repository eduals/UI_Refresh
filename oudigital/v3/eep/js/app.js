...
// ----------------------------------------------------------
// v0.17
// Tooltip prevent default on click of trigger and close button - TODO refactor course forms - TODO set mobile tabs for AccountTabs
// ----------------------------------------------------------
window.OU = window.OU || {};

(function ($, EEP, window, document) {
    EEP.version = "OU.EEP | v0.17";
    ...
    EEP.AccountsTab.prototype = {
        ...
        setTabClickHandler: function () {
            ...
            this.$tabs.click(function (e) {
                e.preventDefault();
                var $thisPill = $(this).parent('li'),
                    formHasChanged = typeof base.options.formHasChanged === 'function' ? base.options.formHasChanged() : false;

                if (formHasChanged) {
                    base.options.formHasChangedFunction();
                } else {
                    base.$pills.removeClass('active');
                    $thisPill.addClass('active');
                    base.hideInactiveTabSection();
                    base.showActiveTabSection();
                }
            });
            return this;
        },
        ...
        enableMobileTabs: function () {
            var toggleMenu = function () {
                $('#account-tabs-nav').toggleClass('int-nav-open');
            };

            $('#account-tabs-toggle').click(function (e) {
                e.preventDefault();
                toggleMenu();
            });
            ...
            this.$tabs.on('click', function (e) {
                $('#account-tabs-toggle').find('.int-active-section').text($(this).text());
...
(function ($, window) {
    ...
    window.OUApp.Modules.modal = {
        ...
        openModal: function (target) {
            ...
            //Below commented out to de-activate the close of the modal when the backdrop has been clicked - DV
